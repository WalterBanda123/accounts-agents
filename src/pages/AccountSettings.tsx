...
const AccountSettings: React.FC = () => {
    ...
    const updateSetting = (key: keyof StoreSettings, value: string | number | boolean) => {
        setSettings(prev => ({
            ...prev,
            [key]: value
        }));
                            ...
                            <IonList lines="none">
                                <IonItem>
                                    ...
                                    <IonSelect
                                        ...
                                        onIonChange={e => updateSetting('primaryCurrency', e.detail.value)}
                                    >
                                ...
                                <IonItem>
                                    ...
                                    <IonSelect
                                        ...
                                        onIonChange={e => updateSetting('secondaryCurrency', e.detail.value)}
                                    >
                                        {CURRENCIES.map(currency => (
                                            <IonSelectOption key={currency.code} value={currency.code}>
                                                {currency.name} ({currency.symbol})
                                ...
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('showDualCurrency', e.detail.checked)}
                                    />
                                </IonItem>

                                <IonItem>
                                    <IonLabel position="stacked">
                                        Exchange Rate (1 {getSelectedCurrency(settings.primaryCurrency)?.symbol} = ? {getSelectedCurrency(settings.secondaryCurrency)?.symbol})
                                    </IonLabel>
                                    <IonInput
                                        type="number"
                                        value={settings.manualExchangeRate}
                                        onIonInput={e => updateSetting('manualExchangeRate', parseFloat(e.detail.value!))}
                                    />
                                </IonItem>
                            </IonList>
                        </IonCardContent>
                            ...
                            <IonList lines="none">
                                <IonItem>
                                    ...
                                    <IonInput
                                        ...
                                        onIonInput={e => updateSetting('storeName', e.detail.value!)}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonTextarea
                                        ...
                                        onIonInput={e => updateSetting('storeAddress', e.detail.value!)}
                                        rows={3}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonInput
                                        ...
                                        onIonInput={e => updateSetting('storePhone', e.detail.value!)}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonInput
                                        ...
                                        onIonInput={e => updateSetting('storeEmail', e.detail.value!)}
                                    />
                                </IonItem>

                                <IonItem>
                                    <IonLabel position="stacked">Business License Number</IonLabel>
                                    <IonInput
                                        value={settings.businessLicense}
                                        onIonInput={e => updateSetting('businessLicense', e.detail.value!)}
                                    />
                                </IonItem>
                            </IonList>
                        </IonCardContent>
                            ...
                            <IonList lines="none">
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('vatEnabled', e.detail.checked)}
                                    />
                                </IonItem>
                                    ...
                                    <>
                                        <IonItem>
                                            ...
                                            <IonInput
                                                ...
                                                onIonInput={e => updateSetting('vatRate', parseFloat(e.detail.value!))}
                                            />
                                        </IonItem>
                                        ...
                                        <IonItem>
                                            ...
                                            <IonInput
                                                ...
                                                onIonInput={e => updateSetting('vatNumber', e.detail.value!)}
                                            />
                                        </IonItem>
                                    </>
                                )}
                            ...
                            <IonList lines="none">
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('receiptLogo', e.detail.checked)}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('printReceipts', e.detail.checked)}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('emailReceipts', e.detail.checked)}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonTextarea
                                        ...
                                        onIonInput={e => updateSetting('receiptFooter', e.detail.value!)}
                                        rows={2}
                                    />
                                </IonItem>
                            </IonList>
                            ...
                            <IonList lines="none">
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('lowStockAlerts', e.detail.checked)}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('dailyReports', e.detail.checked)}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('paymentAlerts', e.detail.checked)}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('systemUpdates', e.detail.checked)}
                                    />
                                </IonItem>
                            </IonList>
                        </IonCardContent>
                            ...
                            <IonList lines="none">
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('requirePin', e.detail.checked)}
                                    />
                                </IonItem>
                                ...
                                <IonItem>
                                    ...
                                    <IonToggle
                                        ...
                                        onIonChange={e => updateSetting('backupEnabled', e.detail.checked)}
                                    />
                                </IonItem>
                            </IonList>
                        </IonCardContent>
