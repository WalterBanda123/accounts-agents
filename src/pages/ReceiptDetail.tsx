        ...
        <IonPage>
            ...
            <IonContent className="receipt-detail-content">
                            ...
                            {receipt.cartItems.map((item) => (
                                <div key={item.id} className="receipt-item">
                                    <div className="item-header">
                                        ...
                                        <span className="item-total">{formatAmount(item.totalPrice)}</span>
                                    </div>
                        ...
                        <div className="receipt-section">
                            ...
                            {receipt.discount && (
                                <div className="receipt-row discount">
                                    ...
                                    <span className="value">-{formatAmount(receipt.discount)}</span>
                                </div>
                            )}
                            <div className="receipt-divider"></div>
                ...
                <div className="action-buttons">
                    <IonButton expand="block" fill="solid" color="primary" onClick={handlePrint}>
                        <IonIcon icon={printOutline} slot="start" />
                        Print Receipt
                    </IonButton>

                    <div className="button-row">
                        <IonButton expand="block" fill="outline" color="primary" onClick={handleSendText}>
                            <IonIcon icon={chatbubbleOutline} slot="start" />
                            Send via Text
                        </IonButton>
                        <IonButton expand="block" fill="outline" color="primary" onClick={handleEmail}>
