...
const NewProduct: React.FC = () => {
    ...
    const categories = [
        { value: 'Beverages', subcategories: ['Soft Drinks', 'Juices', 'Water', 'Energy Drinks'] },
        { value: 'Snacks', subcategories: ['Chips', 'Cookies', 'Nuts', 'Candy'] },
        { value: 'Dairy', subcategories: ['Milk', 'Cheese', 'Yogurt', 'Butter'] },
        { value: 'Bakery', subcategories: ['Bread', 'Pastries', 'Cakes', 'Cookies'] },
        { value: 'Household', subcategories: ['Cleaning', 'Personal Care', 'Paper Products'] }
    ];
    ...
    const validateForm = () => {
        const required = ['name', 'category', 'subcategory', 'unitPrice', 'quantity', 'brand', 'supplier'];
