...
const Stocks: React.FC = () => {
    const [selectedStock, setSelectedStock] = useState<Partial<StockItem> | null>(null);
                ...
                <div className="product-detail">
                  ...
                  <div className="detail-section">
                    ...
                    >
                      ...
                      help you restock this item using natural language. Just
                      tell it what you need, like "Add 50 bottles" or "Restock
                      20 units".
                    </p>
                    <IonButton
                      expand="block"
