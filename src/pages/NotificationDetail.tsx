...
const MOCK_NOTIFICATIONS: Notification[] = [
    {
        ...
        fullMessage: 'Your inventory levels for Coca-Cola 2L bottles have dropped below the minimum threshold of 10 units. Current stock: 5 units remaining. We recommend restocking soon to avoid potential stockouts during peak hours.',
        type: 'warning',
    ...
    },
    {
        ...
        fullMessage: 'Transaction successfully completed. Payment of $45.67 has been received from customer #1234 via card payment. The transaction includes 3 items and has been processed without any issues.',
        type: 'success',
    ...
    },
    {
        ...
        fullMessage: 'Your daily sales report for today has been generated and is ready for review. Total revenue: $567.89 across 23 transactions. This represents a 15% increase compared to yesterday.',
        type: 'info',
    ...
    },
    {
        ...
        fullMessage: 'It\'s time for your scheduled inventory count update. The Electronics category requires immediate attention due to recent stock movements. Please review and update counts for all items in this category.',
        type: 'inventory',
        timestamp: '1 day ago',
        isRead: true,
        priority: 'medium',
    ...
    },
    {
        ...
        fullMessage: 'Payment processing failed for transaction #5678. The customer\'s card was declined due to insufficient funds. Please contact the customer to arrange alternative payment or retry the transaction.',
        type: 'error',
    ...
    },
    {
        ...
        fullMessage: 'iPhone 15 Pro has been successfully added to your inventory system. The product is now available for sale and has been assigned SKU: IPH15PRO001. Initial stock quantity: 10 units.',
        type: 'success',
                ...
                <div className="notification-detail-container">
                    ...
                    <div className="notification-header">
                        ...
                        <div className="notification-header-content">
                            <div className="notification-title-large">
                                {notification.title}
                                {!notification.isRead && (
                                    <IonBadge color="danger" className="unread-badge">New</IonBadge>
                                )}
                            </div>
                    ...
                    <div className="notification-content-section">
                                ...
                                <div className="details-grid">
                                    {notification.additionalDetails.transactionId && (
                                        <div className="detail-item">
                                            ...
                                            <span className="detail-value">{notification.additionalDetails.transactionId}</span>
                                        </div>
                                    )}
                                    {notification.additionalDetails.amount && (
                                        <div className="detail-item">
                                            <span className="detail-label">Amount:</span>
                                            <span className="detail-value">{notification.additionalDetails.amount}</span>
                                        </div>
                                    )}
                                    {notification.additionalDetails.category && (
                                        <div className="detail-item">
                                            <span className="detail-label">Category:</span>
                                            <span className="detail-value">{notification.additionalDetails.category}</span>
                                        </div>
                                    )}
                                    {notification.additionalDetails.location && (
                                        <div className="detail-item">
                                            <span className="detail-label">Location:</span>
                                            <span className="detail-value">{notification.additionalDetails.location}</span>
                                        </div>
                                    )}
                                    {notification.additionalDetails.affectedItems && (
                                        <div className="detail-item">
                                            ...
                                            <div className="affected-items">
                                                {notification.additionalDetails.affectedItems.map((item, index) => (
                                                    <IonBadge key={index} color="light" className="item-badge">
                                                        {item}
                                                    </IonBadge>
                                                ))}
                                            </div>
                        ...
                        <div className="priority-section">
                            ...
                            <IonBadge
                                color={notification.priority === 'high' ? 'danger' : notification.priority === 'medium' ? 'warning' : 'success'}
